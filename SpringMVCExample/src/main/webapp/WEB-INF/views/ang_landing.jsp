      ...
      <div class="generic-container" ng-controller="UserController as ctrl">
          <div class="panel panel-default">
              ...
              <div class="formcontainer">
                  <form ng-submit="ctrl.callAngController()" name="myForm" class="form-horizontal">
                      <div class="row">
                          <div class="form-group col-md-9">
                              <label class="col-md-2 control-lable" for="file">Age</label>
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.user.username" name="uname" class="username form-control input-sm" placeholder="Enter your age" required ng-minlength="3"/>
                              </div>
                          </div>
                      </div>
                      <div class="row">
